                ...
                <div class="schedules-content">
                    <div class="schedules-content-header">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <p class="schedules-text">${planDescription.name}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                                <span class="col-sm-2 label-size col-form-label">
                    ...
                    <c:forEach items="${planToPrint}" var="plan">
                    <table class="table">
                        <thead>
                        <tr class="d-flex">
                        ...
                        <tr class="d-flex">
                            ...
                            <td class="col-7">${plan.recipeName}</td>
                            <td class="col-1 center">
                                <a href="/app/plan/removerecipe?id=${plan.recipePlanId}" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                            </td>
