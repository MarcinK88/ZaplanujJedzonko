    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <div class="alert">Czy na pewno chcesz usunąć plan?
                </div>
                <form action="/app/plan/remove" method="post">
                    <input type="hidden" name="planId" id="planId" value="<%= request.getParameter("id") %>">
